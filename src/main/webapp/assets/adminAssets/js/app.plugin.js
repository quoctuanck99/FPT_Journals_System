!function ($) {
  ...
  $(function(){
	...
	//thay the autoclose, nhung bi nhuoc diem la neu thay doi nam thi gia tri thuc su se ko doi. Nen bo di vay
  ...
  $(document).on('change', '.wizard', function (e, data) {
	...
	// add notes
	function addMsg($msg){
		var $el = $('.nav-customer'), $n = $('.count:first', $el), $v = parseInt($n.text());
