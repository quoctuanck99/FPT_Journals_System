...
["sScrollY","sY"],["bScrollCollapse","bCollapse"]]);D(k.oLanguage,h,"fnInfoCallback");y(k,"aoDrawCallback",h.fnDrawCallback,"customer");y(k,"aoServerParams",h.fnServerParams,"customer");y(k,"aoStateSaveParams",h.fnStateSaveParams,"customer");y(k,"aoStateLoadParams",h.fnStateLoadParams,"customer");y(k,"aoStateLoaded",h.fnStateLoaded,"customer");y(k,"aoRowCallback",h.fnRowCallback,"customer");y(k,"aoRowCreatedCallback",h.fnCreatedRow,"customer");y(k,"aoHeaderCallback",h.fnHeaderCallback,"customer");y(k,"aoFooterCallback",h.fnFooterCallback,
"customer");y(k,"aoInitComplete",h.fnInitComplete,"customer");y(k,"aoPreDrawCallback",h.fnPreDrawCallback,"customer");n=k.oClasses;h.bJQueryUI?(g.extend(n,p.ext.oJUIClasses,h.oClasses),h.sDom===m.sDom&&"lfrtip"===m.sDom&&(k.sDom='<"H"lfr>t<"F"ip>'),k.renderer)?g.isPlainObject(k.renderer)&&!k.renderer.header&&(k.renderer.header="jqueryui"):k.renderer="jqueryui":g.extend(n,p.ext.classes,h.oClasses);g(this).addClass(n.sTable);if(""!==k.oScroll.sX||""!==k.oScroll.sY)k.oScroll.iBarWidth=Db();!0===k.oScroll.sX&&(k.oScroll.sX=
