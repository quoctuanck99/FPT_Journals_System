...
<div class="col-md-12">
	<ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
		<li class="nav-item active"><a class="nav-link"
			id="dashboard-tab" data-toggle="tab" href="#noidungxuatban" role="tab"
			aria-controls="dashboard" aria-selected="true" aria-expanded="true">Nội
				dung bài viết</a></li>
		<li class="nav-item"><a class="nav-link" id="account-tab"
			data-toggle="tab" href="#yeucauxuatban" role="tab" aria-controls="account"
			aria-selected="false">Yêu cầu xuất bản</a></li>

	</ul>
	<div class="tab-content" id="myTabContent">
		<div class="tab-pane fade active in" id="noidungxuatban" role="tabpanel"
