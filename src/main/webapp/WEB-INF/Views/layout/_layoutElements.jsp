...
<%-- 			<script src="<c:url value="/assets/js/jquery-1.11.1.min.js"/>"></script>
			...
			<script src="<c:url value="/assets/rs-plugin/js/jquery.themepunch.revolution.min.js"/>"></script>
			<script src="<c:url value="/assets/rs-plugin/js/jquery.themepunch.tools.min.js"/>"></script>
			<script src="<c:url value="/assets/js/datatables.min.js"/>"></script>
			<script src="<c:url value="/assets/js/modaal.min.js"/>"></script>
			<script src="<c:url value="/assets/js/elements.js"/>"></script> --%>
		<%-- 	
