			...
			<div class="col-md-3">
				<div class="footer-widget">
					<div class="educa-info">
						<img src="<c:out value="${pageContext.servletContext.contextPath}"/>/assets/images/logo-2.png" alt="">
			...
			<div class="col-md-3">
				<div class="footer-widget">
					<div class="university-address">
						...
						<div class="line-dec"></div>
						<ul>
							<li><i class="fa fa-home"></i>1107 Wood Street Saginaw, MI
								New York 48607</li>
			...
			<div class="col-md-3">
				<div class="footer-widget">
					<div class="newsletters">
						<h2>Newsletters</h2>
						<div class="line-dec"></div>
						<p>Subsrcibe to our newsletter for latest updates about our
							site for universe.</p>
						<input type="text" class="email" name="s"
