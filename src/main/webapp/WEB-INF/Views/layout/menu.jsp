<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div class="related-courses">
		...
		<ul>
			...
			<li><a href="single-course.html"><img
					src="https://www.mdpi.com/img/journals/mathematics-logo-sq.png"
					alt="" width="70px"></a> <span>#02</span> <a
				href="single-course.html">
					<h6>Mathematics</h6>
			</a>
				<p>
					Tổng số bài viết: <em>70</em>
				</p></li>
			<li><a href="single-course.html"><img
					src="https://www.mdpi.com/img/journals/genes-logo-sq.png?0076f27502327a8b"
					width="70px" alt=""></a> <span>#03</span> <a
				href="single-course.html">
					<h6>Languages</h6>
			</a>
				<p>
					Tổng số bài viết: <em>50</em>
				</p></li>
		</ul>
	</div>
