...
<ul>
	...
	<!-- reviewer left side bar -->
		...
		<ul class="sub-menu">
			<li><a href="../phan-bien-vien/quan-ly-bai-viet-duoc-chi-dinh">Quản lý bài viết được chỉ định</a></li>
			<li><a href="../phan-bien-vien/danh-gia-bai-viet-duoc-chi-dinh">Đánh giá bài viết được chỉ định</a></li>
		</ul></li>
