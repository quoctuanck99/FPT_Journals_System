...
<ul>
	...
	<!-- reviewer left side bar -->
		<hr class="hr-leftsidebar">
		<li class="menu-item-has-children"><a href="#">QUẢN LÝ BÀI VIẾT ĐÃ XUẤT BẢN</a>
		<ul class="sub-menu">
			<li><a href="../tong-bien-tap-theo-chuyen-san/quan-ly-bai-viet-da-duoc-xuat-ban">Quản lý bài viết được chỉ định</a></li>
			<li><a href="../tong-bien-tap-theo-chuyen-san/xem-bai-viet-da-duoc-xuat-ban">Xem bài viết được chỉ định</a></li>
		</ul></li>
