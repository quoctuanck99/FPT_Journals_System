				...
				<div class="row">
					<div class="col-md-12">
						...
						<table id="table" class="display table-striped table-bordered"
							...
							<tbody>
								<tr>
									<td><a href="<c:out value="${pageContext.servletContext.contextPath}"/>/tac-gia/theo-doi-phan-bien">[applsci-1234]</a></td>
									<td>Ứng dụng khoa học</td>
									<td></td>
									<td>Máy tính và trí tuệ nhân tạo</td>
									<td>Secure and Dynamic Access Controll for Internet of Things (IoT) base
									Traffic System
									</td>
