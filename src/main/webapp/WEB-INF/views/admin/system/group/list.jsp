    ...
    <section class="vbox">
        <section class="scrollable padder">
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li><a href="<%=request.getContextPath()%>/admin/system/group/list">Nhóm quyền</a></li>
                <li><a href="javascript:void(0)">Danh sách</a></li>
            </ul>
            <div class="m-b-md" id="sansim-status"><h3 class="m-b-none" style="color: #009900"><c:if test="${success.length()>0}">${success}</c:if></h3>
                <h3 class="m-b-none" style="color: red"><c:if test="${messageError.length()>0}">${messageError}</c:if></h3>
            </div>

            <section class="panel panel-default">
                <header class="panel-heading"><i class="fa fa-caret-square-o-right"></i> Danh sách nhóm quyền
                ...
                <div class="text-sm wrapper bg-light lt">
                    <form cssClass="form-inline padder" action="list" id="formItem" role="form" theme="simple" >
                        <div class="form-group">
                            <div class="col-md-6">
                                <div class="col-sm-8">
                                    <input name="filterName"  placeholder="Tên nhóm" maxlength="50" value="${filterName}" class="input-sm form-control"/>
                            ...
                            <div class="col-md-6">
                                <a class="btn btn-sm btn-primary pull-right"
                                   href="<%=request.getContextPath()%>/admin/system/group/add"><i class="fa fa-plus"></i> Thêm mới</a>
                            </div>
                        </div>
                            ...
                            <tr>
                                ...
                                <td class="align-center">
                                    ...
                                    <sec:authorize access="hasAnyRole('ROLE_SYSTEM_GROUP_EDIT')">
                                        <a href="<%=request.getContextPath()%>/admin/system/group/edit/${item.id}">
                                    ...
                                    <sec:authorize access="hasAnyRole('ROLE_SYSTEM_GROUP_DELETE')">
                                            <a class="deleteItem"
                                               ...
                                               data-item.name="${item.groupName}">
                                                <img class="icon_action_in_list" src="<%=request.getContextPath()%>/assets/images/adminImage/images/delete.png" title="Xóa">
                                            </a>
                                    </sec:authorize>
                                </td>
                                </sec:authorize>
...
<div class="modal fade"  id="deleteItem"  role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog" style="max-width: 500px;">
        <div class="modal-content"style="max-width: 500px;">
            ...
            <form id="filter" method="POST"  action="<%=request.getContextPath()%>/admin/system/group/delete" theme="simple" enctype="multipart/form-data" cssClass="form-horizontal" cssStyle="" validate="false">
