		...
		<section class="scrollable padder">
			...
			<section class="panel panel-default">
				<header class="panel-heading">
					<i class="fa fa-caret-square-o-right"></i> Chỉnh sửa nhóm quyền
				</header>
				<div class="panel-body" style="min-height: 600px;">
					<form method="post"
						action="<%=request.getContextPath()%>/admin/system/group/edit"
							...
							<div class="col-sm-10">
								<div class="input-group m-b">
									<span class="input-group-addon"> <i class="fa fa-user"
										...
										value="${item.groupName}" name="groupName" /> <input
										type="hidden" class="form-control input-sm" value="${item.id}"
										name="id" />
							...
							<div class="col-md-12" style="margin-left: 40px">
								<div>
									<span><input type="checkbox" id="grantCheckAll"
										name="checkAll" /> &nbsp;<label class="font-bold">Tất
											cả các quyền</label></span>
								</div>
											...
											<tbody>
												...
												<tr>
													<td style="padding-left: 15px; vertical-align: top;">
														...
														class="font-bold"> ${group.parent.description}</label>
													</td>
												</tr>
