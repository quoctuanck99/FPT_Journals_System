	...
	<section class="vbox">
		<section class="scrollable padder">
			<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
				...
				<li><a
					href="<%=request.getContextPath()%>/admin/system/group/list">Group</a></li>
			...
			<section class="panel panel-default">
				<header class="panel-heading">
					<i class="fa fa-caret-square-o-right"></i> Thêm mới nhóm quyền
				</header>
				<div class="panel-body" style="min-height: 600px;">
					<form method="post" action="add" theme="simple"
						enctype="multipart/form-data" class="form-horizontal" cssStyle=""
						validate="true">
						<div class="form-group">
							<label class="col-sm-2 control-label" style="line-height: 30px">Tên
							...
							<div class="col-sm-10">
								<div class="input-group m-b">
									<span class="input-group-addon"> <i class="fa fa-user"
										...
										value="${item.groupName}" name="groupName"
										data-required="true" placeholder="Tên nhóm người sử dụng"
										data-required="true"
										data-required-message="<font color=green>Tên nhóm</font> không được bỏ trống"
										data-maxlength="100"
						...
						<div class="form-group">
							<label class="col-sm-2 control-label" style="line-height: 30px">Diễn
								giải </label>

							<div class="col-sm-10">
								<textarea name="description" path="" class="form-control">${item.description}</textarea>
						...
						<div class="form-group m-b-xs">
							...
							<div class="col-lg-12" style="margin-left: 40px">
								<div>
									<span><input type="checkbox" id="grantCheckAll"
										name="checkAll" /> &nbsp;<label>Tất cả các quyền</label></span>
								</div>
											...
											<tbody>
												...
												<tr>
													<td style="padding-left: 15px; vertical-align: top;">
														<input type="checkbox" name="listAuthority"
														value="${group.parent.id}" onchange="checkAllInRow(this)" /><label>
															${group.parent.description}</label>
													</td>
												</tr>
												<c:forEach var="children" items="${group.childrens}">
													<tr>
														<td style="padding-left: 40px; vertical-align: top;">
															<input type="checkbox" name="listAuthority"
															onchange="checkChildren(this)" value="${children.id}"
						...
						<div class="line line-dashed line-lg pull-in"
							style="clear: both; margin-bottom: 50px"></div>
						<div class="form-group">
							<div class="col-sm-4 col-sm-offset-5">
								<a href="<%=request.getContextPath()%>/admin/system/group/list"
									class="btn btn-default">Hủy bỏ</a>
								<button type="submit" data-loading-text="Thêm mới"
...
<script>
	...
	function checkAllInRow(e) {
		if ($(e).is(':checked'))
			$(e).parent().parent().parent().find("input:checkbox").each(
					function() {
						$(this).prop('checked', true);
					});
		else
	...
	function checkChildren(e) {
		...
		function checkAllValue() {
			var result = true;
			$(e).parent().parent().parent().find("input[type='checkbox']")
					.each(function(i) {
