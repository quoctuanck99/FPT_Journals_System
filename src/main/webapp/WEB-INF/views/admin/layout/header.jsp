...
<header class="bg-dark dk header navbar navbar-fixed-top-xs"
	...
	<ul class="nav navbar-nav navbar-right hidden-xs nav-user ">
				...
				<section class="panel bg-white">
					...
					<div class=" list-group-alt animated fadeInRight">
						<a href="#" class="media list-group-item"> <span
							class="pull-left thumb-sm"> <i class="fa fa-book fa-3x"></i>
						</span> <span class="media-body block m-b-none"> hỗ trợ </span>
						</a>
					</div>
				</section>
			</section>
		...
		<li class="dropdown" style="margin-right: 14px;"><a href="#"
			class=" dropdown-toggle " data-toggle="dropdown"> <span
				class="thumb-sm avatar pull-left"> <img
					src="<%=request.getContextPath()%>/assets/images/user.png">
			</span></span> <sec:authentication property="principal.fullName" /> <b
				class="caret"></b>
		</a>
			<ul class="dropdown-menu animated fadeInRight ">
				...
				<li><a
					href="<%=request.getContextPath()%>/admin/system/user/change-my-pass">Đổi
						mật khẩu</a></li>
				<li class="divider"></li>
				<li><a
